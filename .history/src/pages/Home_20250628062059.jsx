...
function Home() {
  return (
    <div className="relative min-h-screen bg-primary dark:bg-primary-dark text-white flex items-center justify-center p-6 font-bitcount">
      ...
      {/* Card */}
      <div className="relative z-10 rounded-lg shadow-[24px_20px_33px_0px_#000000] text-primary-dark dark:bg-primary bg-primary-dark border-2 border-white p-10 shadow-xl max-w-xl">
