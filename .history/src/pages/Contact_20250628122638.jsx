...
function Contact() {
    ...
    return (
        <div className="relative min-h-screen flex items-start sm:items-center justify-center font-bitcount bg-dark dark:bg-light border-2 shadow-[-11px_1px_31px_-13px_#000000] p-4">
                ...
                <div className="shadow-[24px_20px_33px_0px_#000000] border-2 overflow-hidden rounded-lg">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <section className="p-6 md:p-10 border-b md:border-b-0 md:border-r-2">
                            ...
                            <h2>Contact Information</h2>  {/* Replace with your actual content */}
                        </section>
                            ...
                            <form className="space-y-4" onSubmit={handleSubmit}> {/* Add onSubmit handler */}
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="mt-1 py-2 px-3 block w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-semibold shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                    />
                                </div>
                                <div>
            ...
            {isModalOpen && (
                <div className="fixed z-50 top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center">
                    <div className="bg-light dark:bg-dark rounded-lg p-8 shadow-xl border-2 border-red-500">
                        <h2 className="text-2xl font-bold text-red-600 dark:text-red-400 mb-4">Email Not Sent</h2>
