                        ...
                        <section className="p-6 flex flex-col justify-center bg-light dark:bg-dark">
                            <form className="space-y-4" onSubmit={handleSubmit}> {/* Add onSubmit handler */}
                                ...
                                <div>
                                    <button
                                        type="submit"
                                        className="w-full py-2 px-4 rounded-md bg-dark dark:bg-black text-text-light dark:text-text-dark font-semibold shadow-md hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                                    >
                                        Submit
                                    </button>
                                </div>
