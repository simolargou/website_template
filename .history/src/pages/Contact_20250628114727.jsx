  ...
  return (
    <PageWrapper>
      <div className="relative min-h-screen flex items-start sm:items-center justify-center font-bitcount 
                      bg-dark dark:bg-light border-2 shadow-[-11px_1px_31px_-13px_#000000]">
        <div className="max-w-6xl w-full sm:px-0 lg:px-0 bg-light dark:bg-dark">
          <div className="shadow-[24px_20px_33px_0px_#000000] border-2 overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              {/* Kontaktformular */}
              <form className="p-6 flex flex-col justify-center bg-light dark:bg-dark">
                <input
                  type="text"
                  name="name"
                  placeholder="Full Name"
                  className="mt-2 py-3 px-3 rounded-lg border border-gray-400 dark:border-gray-700 
                             bg-white dark:bg-dark text-gray-800 font-semibold 
                ...
                <button
                  type="submit"
                  className="mt-6 py-3 px-6 rounded-lg bg-dark dark:bg-light 
