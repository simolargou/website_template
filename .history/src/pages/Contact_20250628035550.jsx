...
function Contact() {
  return (
    <div className="border-4 relative flex font-bebas items-top justify-center min-h-screen  sm:items-center sm:pt-0">
      <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <div className="mt-8 overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="p-2 mr-2   sm:rounded-lg">
              <h1 className="text-6xl sm:text-5xl text-gray-800 dark:text-white font-extrabold tracking-tight">
                Lets connect
              </h1>
