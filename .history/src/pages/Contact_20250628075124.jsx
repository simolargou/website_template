...
function Contact() {
  return (
    <PageWrapper>
    <div className="border-2 shadow-[24px_20px_33px_0px_#000000] relative flex font-bitcount bg-background-light dark:bg-background-dark items-top justify-center min-h-screen  sm:items-center sm:pt-0">
