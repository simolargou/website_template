...
function Contact() {
    ...
    return (
        <div className="relative min-h-screen flex items-start sm:items-center justify-center font-forum bg-white dark:bg-light border-2 shadow-[-11px_1px_31px_-13px_#000000] p-4">
            <div className="max-w-6xl w-full sm:px-0 lg:px-0 bg-white dark:bg-dark">
