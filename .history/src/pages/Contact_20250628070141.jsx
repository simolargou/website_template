        ...
        <div className="border-4 mt-2 overflow-hidden shadow-[24px_20px_33px_0px_#000000]">
          <div className="grid grid-cols-1 md:grid-cols-2 ">
            ...
            <form className="p-6 flex flex-col justify-center">
              ...
              <button
                type="submit"
                className="md:w-32  dark:text-text-light dark:bg-background-dark bg-background-light font-bold py-3 px-6 rounded-lg mt-3 hover:bg-grey-400 transition ease-in-out duration-300"
              >
                Submit
              </button>
            </form>
