...
function Contact() {
    ...
    return (
        <div className="relative min-h-screen flex items-start sm:items-center justify-center font-forum bg-dark dark:bg-light border-2 shadow-[-11px_1px_31px_-13px_#000000] p-4">
            <div className="max-w-6xl w-full sm:px-0 lg:px-0 bg-light dark:bg-dark">
                <div className="shadow-[24px_20px_33px_0px_#000000] border-2 overflow-hidden rounded-lg">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4  place-items-center">
                        {/* Contact Information */}
                        <section className="p-6 md:p-10 border-b md:border-b-0 md:border-r-2 justify-center">
                            {/* Contact Information Content */}
                            <h2 className='text-2xl font-bold' >Contact Information</h2>  {/* Replace with your actual content */}
