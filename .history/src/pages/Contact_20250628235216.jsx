                            ...
                            <form className="space-y-4" onSubmit={handleSubmit}> {/* Add onSubmit handler */}
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="mt-1 py-2 px-3 block w-full rounded-md border border-gray-300 dark:border-gray-700 bg-dark dark:bg-light text-dark dark:text-gray-200 font-semibold shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                    />
                                </div>
                                <div>
