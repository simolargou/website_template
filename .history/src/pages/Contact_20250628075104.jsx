...
function Contact() {
  return (
    <PageWrapper>
    <div className="border-2 relative flex font-bitcount bg-background-light dark:bg-background-dark items-top justify-center min-h-screen  sm:items-center sm:pt-0">
