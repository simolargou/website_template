...
function Home() {
  return (
    <PageWrapper>
    <div className="relative min-h-auto bg-primary dark:bg-background-light bg-background-dark text-text-light dark:text-text-dark flex items-center justify-center p-6 font-bitcount">
      ...
      <div className="relative z-10 rounded-lg shadow-[24px_20px_33px_0px_#000000]  dark:bg-background-dark bg-background-light border-2 border-white p-10 shadow-xl max-w-xl">
        ...
        <p className="text-lg mb-4">
          i am passionate frontend-backend Developer <em> Also</em> Data Science and AI
        </p>
