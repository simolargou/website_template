...
function Home() {
  return (
    <div className="relative min-h-screen bg-primary dark:bg-background-light bg-background-dark text-text-dark dark:text-text-dark flex items-center justify-center p-6 font-bitcount">
