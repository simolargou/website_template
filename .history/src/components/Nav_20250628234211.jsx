...
export default function Nav({ darkMode, toggleDarkMode }) {
  ...
  return (
    <nav className="dark:text-text-dark text-text-light font-bitcount p-4 text-xl dark:bg-dark bg-light sticky top-0 z-50 font-forum"> {/* Added padding and sticky top */}
      ...
      >
        <Link to="/" className="block px-3 py-2 rounded hover:bg-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2" onClick={handleToggleMenu}>Home</Link>  {/* Used Link, added focus, close on click */}
