...
export default function Nav({ darkMode, toggleDarkMode }) {
  ...
  return (
    <nav className="dark:text-text-dark text-text-light font-bitcount p-0 text-xl dark:bg-dark bg-light">
      <div className="max-w-7xl mx-auto px-4 flex justify-between items-center h-16">
        ...
        <div className="hidden md:flex space-x-6">
          ...
          <button
            ...
            className="ml-0 px-2 py-0 rounded text-yellow-400  dark:text-white text-sm"
          >
