...
export default function Nav({ darkMode, toggleDarkMode }) {
  ...
  return (
    <nav className="dark:text-text-light text-text-dark font-sintony p-0 text-xl dark:bg-primary">
      <div className="max-w-7xl mx-auto px-4 flex justify-between items-center h-16">
        ...
        <div className="hidden  md:flex space-x-6  ">
          ...
          <button
            ...
            className="ml-4 px-3 py-1 rounded bg-gray-200 text-black dark:bg-gray-800 dark:text-white text-sm"
          >
            {darkMode ? '🌙 ' : '☀️'}
          </button>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden px-4 pt-2 pb-4 space-y-2 mx-auto w-fit">
          ...
          <button
            onClick={toggleDarkMode}
            className="w-full text-left px-3 py-2 rounded bg-gray-200 text-black dark:bg-gray-800 dark:text-white"
          >
