...
function App() {
  ...
  return (
    <Router>
      <div className="min-h-screen bg-white text-black  dark:text-green-950 transition-colors duration-300">
        <header className=" dark:bg-gradient-to-t from-stone-500 to-cyan-800   p-1">
